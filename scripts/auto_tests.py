...
MODELING_QWEN3_5_DFLASH_EXE_REL = GENAI_BIN_REL / "modeling_qwen3_5_dflash.exe"
MODELING_QWEN3_TTS_EXE_REL = GENAI_BIN_REL / "modeling_qwen3_tts.exe"
MODELING_ACADEMIC_DS_EXE_REL = GENAI_BIN_REL / "modeling_academic_ds.exe"
MODELING_SEED_OSS_EXE_REL = GENAI_BIN_REL / "modeling_seed_oss.exe"
...
TEST_SPECS: List[Dict[str, Any]] = [
    ...
    {
        "name": "Huggingface Qwen3.5-4B DFlash (block_size=16)",
        "model_rel": Path("Huggingface") / "Qwen3.5-4B",
        "draft_model_rel": Path("Huggingface") / "Qwen3.5-4B-DFlash-b16",
        "exe_rel": MODELING_QWEN3_5_DFLASH_EXE_REL,
        "work_dir_rel": TEXT_WORK_DIR_REL,
        "command_args": MODELING_QWEN3_5_DFLASH_ARGS.copy(),
        "is_dflash": True,
    },
    {
    ...
    {
        "name": "Huggingface academic-ds-9B modeling_academic_ds (fp16)",
        "model_rel": Path("Huggingface") / "academic-ds-9B",
        "exe_rel": MODELING_ACADEMIC_DS_EXE_REL,
        "work_dir_rel": TEXT_WORK_DIR_REL,
        "command_args": MODELING_ACADEMIC_DS_ARGS.copy(),
    },
    {
        "name": "Huggingface academic-ds-9B modeling_academic_ds (int4_asym)",
        "model_rel": Path("Huggingface") / "academic-ds-9B",
        "exe_rel": MODELING_ACADEMIC_DS_EXE_REL,
        "work_dir_rel": TEXT_WORK_DIR_REL,
        "command_args": MODELING_ACADEMIC_DS_ARGS.copy(),
        "extra_env": {
            "OV_GENAI_INFLIGHT_QUANT_MODE": "int4_asym",
            "OV_GENAI_INFLIGHT_QUANT_GROUP_SIZE": "128",
            "OV_GENAI_INFLIGHT_QUANT_BACKUP_MODE": "int8_asym",
        },
    },
    {
        "name": "Huggingface seed-oss-36B-Instrust modeling_seed_oss (fp16)",
        "model_rel": Path("Huggingface") / "seed-oss-36B-Instrust",
        "exe_rel": MODELING_SEED_OSS_EXE_REL,
        "work_dir_rel": TEXT_WORK_DIR_REL,
        "command_args": MODELING_SEED_OSS_ARGS.copy(),
    },
    {
        "name": "Huggingface seed-oss-36B-Instrust modeling_seed_oss (int4_asym)",
        "model_rel": Path("Huggingface") / "seed-oss-36B-Instrust",
        "exe_rel": MODELING_SEED_OSS_EXE_REL,
        "work_dir_rel": TEXT_WORK_DIR_REL,
        "command_args": MODELING_SEED_OSS_ARGS.copy(),
